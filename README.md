...
- **[Categories](https://jekyllrb.com/docs/front-matter/#predefined-variables-for-posts)**: GitHub-Pages-Preview doesn't support them, as I don't use them in my site. If there's a need, however, that can be changed
- **[Collections](https://jekyllrb.com/docs/collections/)**: Other than posts and drafts, not yet supported
